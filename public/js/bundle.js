      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error when trying to logged out , please try again');
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    marker.className = 'marker'; // Add the marker
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setText("Day : ".concat(loc.day, " : ").concat(loc.description)).addTo(map); // extend map bounds to include current location
...
/* eslint-disable */
var stripe = Stripe('pk_test_itHipab76wgXwCkmKyL7emQZ00SJjSqqa2');
...
var formEl = document.querySelector('.form--login');
